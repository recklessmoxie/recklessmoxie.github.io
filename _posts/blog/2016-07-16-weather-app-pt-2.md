...
<p>The browser's developer console proved to be a great tool, and learning experience for me. Once the ip-api call function and the variable to hold the data were written, console.log() verified the data I needed was there. </p>
